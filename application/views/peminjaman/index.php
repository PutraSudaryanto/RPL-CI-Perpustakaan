        ...
        $("#simpan").click(function(){
            ...
            if (nia=="") {
                ...
                $.ajax({
                    ...
                    type:"POST",
                    data:"nomer="+nomer+"&pinjam="+pinjam+"&kembali="+kembali+"&nia="+nia+"&jumlah="+jumlah,
                    cache:false,
                    success:function(html){
        ...
        <form class="form-horizontal" action="<?php echo site_url('peminjaman/simpan');?>" method="post">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-lg-7">
                        <select name="nia" class="form-control" id="nia">
                           <option></option>
                           <?php foreach($anggota as $anggota):?>
                           <option value="<?php echo $anggota->nia;?>"><?php echo $anggota->nia;?></option>
                            <?php endforeach;?>
                        </select>
                    </div>
                </div>
