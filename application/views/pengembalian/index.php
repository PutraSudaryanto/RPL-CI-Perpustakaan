<script>
    $(function(){
        ...
        $("#carinia").keyup(function(){
            var nia=$("#carinia").val();
            
            $.ajax({
                url:"<?php echo site_url('pengembalian/cari_by_nia');?>",
                type:"POST",
                data:"nia="+nia,
                cache:false,
                success:function(html){
...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form class="form-horizontal" action="" method="post">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label class="col-lg-4 control-label">nia</label>
                    <div class="col-lg-7">
                        <input type="text" name="nia" id="nia" class="form-control" readonly="readonly">
                    </div>
                </div>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                        <div class="form-horizontal">
                            <div class="form-group">
                                <label class="col-lg-5">Cari nia Peminjam</label>
                                <div class="col-lg-5">
                                    <input type="text" id="carinia" class="form-control">
                                </div>
                            </div>
                        </div>
                        
                        <div id="tampilnia"></div>
                  </div>
                </div><!-- /.modal-content -->
              </div><!-- /.modal-dialog -->
            </div><!-- /.modal -->